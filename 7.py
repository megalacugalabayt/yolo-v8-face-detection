...
def connect_to_pixhawk(connection_string, baudrate=921600):
    try:
...
def process_frame(master, frame):
    ...
    if len(faces) > 0:
        ...
        if face_center_x < frame_center_x - 50:
            motor1 = 1150  # Motor 1 hızını düşür
        elif face_center_x > frame_center_x + 50:
            motor3 = 1150  # Motor 3 hızını düşür
        
        if face_center_y < frame_center_y - 50:
            motor2 = 1150  # Motor 2 hızını düşür
        elif face_center_y > frame_center_y + 50:
            motor4 = 1150  # Motor 4 hızını düşür
